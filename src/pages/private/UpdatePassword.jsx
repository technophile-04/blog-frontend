...
import { updateUserPasswordAction } from '../../redux/slices/user/userSlice';
...
const UpdatePassword = () => {
	...
	const { loading, serverErr, appErr } = useSelector((state) => state?.users);
	//formik
	...
	return (
		<div className="fill-available bg-gray-700  flex flex-col justify-center py-12 sm:px-6 lg:px-8">
			...
			<div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
				<div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
					{serverErr || appErr ? (
						<h2 className="text-red-500 text-center mb-4 text-lg">
							{serverErr} - {appErr} Failed
						</h2>
					) : null}
