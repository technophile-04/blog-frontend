...
import { passwordResetTokenAction } from '../../redux/slices/user/userSlice';
...
const ForgotPassword = () => {
	...
	return (
		<div className="fill-available flex items-center justify-center bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
			<div className="max-w-md w-full space-y-8">
				...
				<div className="text-green-700 text-center">
					{passwordToken && <h3>{passwordToken?.message}</h3>}
				</div>
