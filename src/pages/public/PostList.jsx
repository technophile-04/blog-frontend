			...
			<section>
				<div class="py-20 bg-gray-900 min-h-screen radius-for-skewed">
					<div class="container mx-auto px-4">
						<div class="mb-10 md:mb-16 flex flex-wrap items-center">
							...
							<div class=" block text-right w-full md:w-1/2">
								{/* View All */}
								<button
									onClick={() => dispatch(fetchAllPostsAction(''))}
									class="block md:inline-block py-2 px-6 rounded-l-xl rounded-t-xl bg-green-600 hover:bg-green-700 text-gray-50 font-bold leading-loose transition duration-200 mt-8 mx-auto md:mt-0 md:mx-0"
								>
									View All Posts
								</button>
							</div>
